...
<ul>
  <li>users: Stores user credentials and roles</li>
  <li>tickets: Stores all ticket-related data</li>
</ul>
...
<p align="center">
  <div style="border: 2px solid black; padding: 10px; display: inline-block; border-radius: 8px;">
    <img src="images/Untitled diagram-2025-12-01-042332.png" width="500" height="800" />
  </div>
</p>
...
<p>The users table has a one-to-many relationship with the tickets table in two directions:</p>
<ul>
